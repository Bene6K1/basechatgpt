...
function UIMenuItem.New(Text, Description)
    _UIMenuItem = {
        Rectangle = UIResRectangle.New(0, 0, 431, 38, 239, 24, 75, 20),
        Text = UIResText.New(tostring(Text) or "", 8, 0, 0.33, 239, 24, 75, 255, 0),
        ...
        Label = {
            Text = UIResText.New("", 0, 0, 0.35, 239, 24, 75, 255, 0, "Right"),
            MainColour = { R = 239, G = 24, B = 75, A = 255 },
...
function UIMenuItem:Draw()
    ...
    if self._Enabled then
        if self._Selected then
            ...
            self.Text:Colour(239, 24, 75, 255)
...
function UIMenuListItem.New(Text, Items, Index, Description)
    ...
    local _UIMenuListItem = {
        ...
        ItemText = UIResText.New("", 290, 104, 0.35, 239, 24, 75, 255, 0, "Right"),
...
function UIMenuListItem:Draw()
    ...
    if self:Enabled() then
        if self:Selected() then
            ...
            self.ItemText:Colour(239, 24, 75, 255)
            self.LeftArrow:Colour(239, 24, 75, 255)
            self.RightArrow:Colour(239, 24, 75, 255)
        end
    else
...
function UIMenuSliderItem.New(Text, Items, Index, Description, Divider)
    ...
    local _UIMenuSliderItem = {
        ...
        Background = UIResRectangle.New(0, 0, 150, 9, 239, 24, 75, 255),
        Slider = UIResRectangle.New(0, 0, 75, 9, 239, 24, 75, 255),
...
function UIMenuProgressItem.New(Text, Items, Index, Description, Counter)
    ...
    local _UIMenuProgressItem = {
        ...
        Background = UIResRectangle.New(0, 0, 415, 20, 239, 24, 75, 255),
        Bar = UIResRectangle.New(0, 0, 407.5, 12.5, 239, 24, 75, 255),
...
function UIMenuGridPanel.New(TopText, LeftText, RightText, BottomText)
    _UIMenuGridPanel = {
        ...
        Background = Sprite.New("commonmenu", "gradient_bgd", 0, 0, 431, 275, 0, 239, 24, 75, 255),
        ...
        ParentItem = nil,
        Text = {
            Top = UIResText.New(TopText or "Top", 0, 0, 0.35, 239, 24, 75, 255, 0, "Centre"),
            Left = UIResText.New(LeftText or "Left", 0, 0, 0.35, 239, 24, 75, 255, 0, "Centre"),
            Right = UIResText.New(RightText or "Right", 0, 0, 0.35, 239, 24, 75, 255, 0, "Centre"),
            Bottom = UIResText.New(BottomText or "Bottom", 0, 0, 0.35, 239, 24, 75, 255, 0, "Centre"),
        },
    }
...
function UIMenuColourPanel.New(Title, Colours)
    _UIMenuColourPanel = {
        ...
        Background = Sprite.New("commonmenu", "gradient_bgd", 0, 0, 431, 112, 0, 239, 24, 75, 255),
        Bar = {},
        ...
        Text = UIResText.New(Title .. " (1 of " .. #Colours .. ")" or "Title" .. " (1 of " .. #Colours .. ")", 0, 0, 0.35, 239, 24, 75, 255, 0, "Centre"),
        ParentItem = nil,
    }
...
function UIMenuPercentagePanel.New(MinText, MaxText)
    _UIMenuPercentagePanel = {
        ...
        Background = Sprite.New("commonmenu", "gradient_bgd", 0, 0, 431, 76, 0, 239, 24, 75, 255),
        ActiveBar = UIResRectangle.New(0, 0, 413, 10, 239, 24, 75, 255),
        BackgroundBar = UIResRectangle.New(0, 0, 413, 10, 87, 87, 87, 255),
        Text = {
            Min = UIResText.New(MinText or "0%", 0, 0, 0.35, 239, 24, 75, 255, 0, "Centre"),
            Max = UIResText.New("100%", 0, 0, 0.35, 239, 24, 75, 255, 0, "Centre"),
            Title = UIResText.New(MaxText or "Opacity", 0, 0, 0.35, 239, 24, 75, 255, 0, "Centre"),
        },
        Audio = { Slider = "CONTINUOUS_SLIDER", Library = "HUD_FRONTEND_DEFAULT_SOUNDSET", Id = nil },
        ParentItem = nil,
    }
...
function UIMenu.New(Title, Subtitle, X, Y, TxtDictionary, TxtName)
    ...
    local _UIMenu = {
        ...
        Banner = nil,
        Title = UIResText.New(Title, 215 + X, 20 + Y, 1.15, 239, 24, 75, 255, 1, 1),
        Subtitle = { ExtraY = 0 },
        WidthOffset = 0,
        Position = { X = X, Y = Y },
    ...
    if Subtitle ~= "" and Subtitle ~= nil then
        ...
        _UIMenu.Subtitle.Text = UIResText.New(Subtitle, 8 + _UIMenu.Position.X, 110 + _UIMenu.Position.Y, 0.35, 239, 24, 75, 255, 0)
        ...
        _UIMenu.PageCounter.Text = UIResText.New("", 425 + _UIMenu.Position.X, 110 + _UIMenu.Position.Y, 0.35, 239, 24, 75, 255, 0, "Right")
    ...
    _UIMenu.Extra.Up = UIResRectangle.New(0 + _UIMenu.Position.X, 144 + 38 * (_UIMenu.Pagination.Total + 1) + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 431, 18, 239, 24, 75, 200)
    _UIMenu.Extra.Down = UIResRectangle.New(0 + _UIMenu.Position.X, 144 + 18 + 38 * (_UIMenu.Pagination.Total + 1) + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 431, 18, 239, 24, 75, 200)
    ...
    _UIMenu.Description.Text = UIResText.New("Description", _UIMenu.Position.X + 5, 125, 0.35, 239, 24, 75, 255)
...
function UIMenu:ProcessMouse()
    ...
    if IsMouseInBounds(ExtraX, ExtraY, 431 + self.WidthOffset, 18) then
        self.Extra.Up:Colour(239, 24, 75, 255)
        if not self.Controls.MousePressed then
            if IsDisabledControlJustPressed(0, 24) then
                Citizen.CreateThread(function()
        ...
        self.Extra.Up:Colour(239, 24, 75, 200)
    end

    if IsMouseInBounds(ExtraX, ExtraY + 18, 431 + self.WidthOffset, 18) then
        self.Extra.Down:Colour(239, 24, 75, 255)
        if not self.Controls.MousePressed then
            if IsDisabledControlJustPressed(0, 24) then
                Citizen.CreateThread(function()
                    local _ExtraX, _ExtraY = ExtraX, ExtraY
        ...
        self.Extra.Down:Colour(239, 24, 75, 200)
    end
end
