function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Title = Title or ""
    Menu.TitleFont = ServerFontStyle
    Menu.TitleScale = 1.2
...
---@return nil
---@public
function RageUI.Menus:SetButtonColor(R, G, B, A)
...
---@return nil
---@public
function RageUI.Menus:SetBackgroundColor(R, G, B, A)
    self.BackgroundColor = { R = R or 8, G = G or 8, B = B or 8, A = A or 255 }
end
...
---@return nil
---@public
function RageUI.Menus:SetItemBackgroundColor(R, G, B, A)
    self.ItemBackgroundColor = { R = R or 13, G = G or 13, B = B or 13, A = A or 255 }
end
