...
RageUI.Settings = {
    ...
    Items = {
        Title = {
            Background = { Width = 450, Height = 107 },
            Text = { X = 225, Y = 13, Scale = 1.15 },
        },
        Subtitle = {
            Background = { Width = 450, Height = 37 },
            Text = { X = 15, Y = 11, Scale = 0.25 },
            PreText = { X = 440, Y = 6, Scale = 0.26 },
        },
        Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 0, Width = 450 },
        Navigation = {
            Rectangle = { Width = 449, Height = 0 },
            Offset = 5,
            Arrows = { Dictionary = "commonmenu", Texture = "shop_arrows_upanddown", X = 225, Y = 2, Width = 0 , Height = 0 },
        },
        Description = {
            Bar = { Y = 40, Width = 449, Height = 4 },
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 450, Height = 30 },
            Text = { X = 8, Y = 7.5, Scale = 0.21 },
        },
    },
    Panels = {
        Grid = {
            Background = { Dictionary = "commonmenu.ytd", Texture = "gradient_bgd", Y = 4, Width = 450, Height = 275 },
            Grid = { Dictionary = "pause_menu_pages_char_mom_dad", Texture = "nose_grid", X = 125, Y = 47.5, Width = 200, Height = 200 },
            Circle = { Dictionary = "mpinventory", Texture = "in_world_circle", X = 125, Y = 47.5, Width = 20, Height = 20 },
            Text = {
                Top = { X = 225, Y = 15, Scale = 0.35 },
                Bottom = { X = 225, Y = 250, Scale = 0.35 },
                Left = { X = 67.5, Y = 130, Scale = 0.35 },
                Right = { X = 382.5, Y = 130, Scale = 0.35 },
            },
        },
        Percentage = {
            Background = { Dictionary = "commonmenu.ytd", Texture = "gradient_bgd", Y = 4, Width = 450, Height = 76 },
            Bar = { X = 9, Y = 50, Width = 432, Height = 10 },
            Text = {
                Left = { X = 25, Y = 15, Scale = 0.35 },
                Middle = { X = 225, Y = 15, Scale = 0.35 },
                Right = { X = 425, Y = 15, Scale = 0.35 },
            },
        },
    },
}
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu and (CurrentMenu.Display.Subtitle) then
            ...
            if CurrentMenu.Subtitle ~= "" then
                RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUI.ItemOffset, RageUI.Settings.Items.Subtitle.Background.Width - 1 + CurrentMenu.WidthOffset, RageUI.Settings.Items.Subtitle.Background.Height + CurrentMenu.SubtitleHeight, CurrentMenu.BackgroundColor and CurrentMenu.BackgroundColor.R or 12, CurrentMenu.BackgroundColor and CurrentMenu.BackgroundColor.G or 16, CurrentMenu.BackgroundColor and CurrentMenu.BackgroundColor.B or 21, CurrentMenu.BackgroundColor and CurrentMenu.BackgroundColor.A or 255)
                ...
                RageUI.ItemOffset = RageUI.ItemOffset + RageUI.Settings.Items.Subtitle.Background.Height + 10
            end
        end
    end
end
...
function RageUI.Background()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Background) then
            ...
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUI.Settings.Items.Background.Y + 10 + CurrentMenu.SubtitleHeight, RageUI.Settings.Items.Background.Width - 1 + CurrentMenu.WidthOffset, RageUI.ItemOffset, CurrentMenu.BackgroundColor and CurrentMenu.BackgroundColor.R or 12, CurrentMenu.BackgroundColor and CurrentMenu.BackgroundColor.G or 16, CurrentMenu.BackgroundColor and CurrentMenu.BackgroundColor.B or 21, CurrentMenu.BackgroundColor and CurrentMenu.BackgroundColor.A or 255)
...
function RageUI.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu then
            RageUI.ItemsSafeZone(CurrentMenu)
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + Description.Background.Y + 10 + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Description.Background.Width - 1 + CurrentMenu.WidthOffset, CurrentMenu.DescriptionHeight, CurrentMenu.BackgroundColor and CurrentMenu.BackgroundColor.R or 12, CurrentMenu.BackgroundColor and CurrentMenu.BackgroundColor.G or 16, CurrentMenu.BackgroundColor and CurrentMenu.BackgroundColor.B or 21, CurrentMenu.BackgroundColor and CurrentMenu.BackgroundColor.A or 255)
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.DescriptionHeight + 10 + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Description.Bar.Width + CurrentMenu.WidthOffset, Description.Bar.Height, CurrentMenu.ButtonColor.R, CurrentMenu.ButtonColor.G, CurrentMenu.ButtonColor.B, CurrentMenu.ButtonColor.A)
            RenderText(CurrentMenu.Description, CurrentMenu.X + Description.Text.X, CurrentMenu.Y + Description.Text.Y + 10  + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, Description.Text.Scale, 255, 255, 255, 255, nil, false, false, Description.Background.Width + CurrentMenu.WidthOffset - 8.0)
...
function RageUI.ItemsDescription(CurrentMenu, Description, Selected)
    ...
    if Description ~= "" or Description ~= nil then
        ...
        if Selected and CurrentMenu.Description ~= Description then
            ...
            ---@type number
            local DescriptionLineCount = GetLineCount(CurrentMenu.Description, CurrentMenu.X + SettingsDescription.Text.X, CurrentMenu.Y + SettingsDescription.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, SettingsDescription.Text.Scale, 12, 16, 21, 1, nil, false, false, SettingsDescription.Background.Width + (CurrentMenu.WidthOffset - 5.0))
