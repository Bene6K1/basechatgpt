...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
  ...
  Menu.Title = Title or ""
  Menu.TitleFont = (ServerFontStyle and ServerFontStyle > 0) and ServerFontStyle or 0
...
function RageUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
  self.Sprite =
    { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
  self.Rectangle = nil
end
...
function RageUI.AddMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
  return RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
end

function RageUI.AddSubMenu(
  ParentMenu,
  Title,
  Subtitle,
  X,
