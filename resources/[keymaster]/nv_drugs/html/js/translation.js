...
function setTranslation(newTranslations) {
    ...
    $("#settings-selling-title").text(translate("phone_setting_selling"))

    $("#no-messages").text(translate("phone_no_messages"))
    $("#modal-button-accept").text(translate("modal_accept"))
    $("#modal-button-cancel").text(translate("modal_cancel"))
}