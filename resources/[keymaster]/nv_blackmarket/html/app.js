var inventoryPatch = "nui://@inv/src/html/assets/icons";
const resourceName = typeof GetParentResourceName === "function" ? GetParentResourceName() : "nv_blackmarket";
...
$(document).on("click", ".pay", function () {
  ...
  $.post(
    "https://" + resourceName + "/CompleteOrder",
    JSON.stringify({
      item: cartArray,
    ...
    function (result) {
      if (result) {
        ...
        $(".back-container").hide();
        $(".main-container").hide();
        $.post("https://" + resourceName + "/EscapeFromJs");
      }
    }
  );
});
