...
Config.Lang = 'fr'
Config.Inventory = 'ox_inventory'  -- Changé de 'inv' à 'ox_inventory'
...
Config.Shops = {
    ['clothes'] = {
        ...
        label = 'BINCO',
        blip = { style = 73, color = 81, size = 0.5, name = 'Magasin de vêtements' },
        categories = {
            'torso',
            'tshirt',
            'arms',
    ...
    ['mask'] = {
        ...
        label = 'MASKSHOP',
        blip = { style = 102, color = 18, size = 0.5, name = 'Magasin de masques' },
        categories = {
            'mask',
        }
    },
    ['accessories'] = {
        ...
        label = 'Accessoires',
        blip = { style = 73, color = 81, size = 0.5, name = 'Magasin d\'accessoires' },
        categories = {
            'hat',
            'glasses',
            'earrings',
