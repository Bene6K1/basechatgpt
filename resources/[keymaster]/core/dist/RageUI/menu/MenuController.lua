...
function RageUI.Navigation()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Navigation) then
            if Config and Config.RageUI and Config.RageUI.hideNavigation then
                -- Hide the default navigation bar visuals (white/grey bar) and do not reserve space.
                return
            end
            if CurrentMenu.EnableMouse then
            ...
            if RageUI.Options > CurrentMenu.Pagination.Total then
                ...
                if CurrentMenu.EnableMouse then
                    UpHovered = RageUI.IsMouseInBounds(CurrentMenu.X + CurrentMenu.SafeZoneSize.X,
                    ...
                    DownHovered = RageUI.IsMouseInBounds(CurrentMenu.X + CurrentMenu.SafeZoneSize.X,
                    ...
                    if UpHovered then
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset,
                            RageUI.Settings.Items.Navigation.Width + CurrentMenu.WidthOffset,
                ...
                RenderSprite(RageUI.Settings.Items.Navigation.Arrows.Dictionary,
