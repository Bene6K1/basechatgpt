...
CreateThread(function()
    ...
    while true do
        ...
        for k,v in pairs(SunnyConfigServ.Elevator.positions) do
            ...
            if dist < 1 then
                DrawInstructionBarNotification(v.position.x, v.position.y, v.position.z, ("pour intéragir"):format(UTILS.COLORCODE))
        ...
        for k,v in pairs(SunnyConfigServ.Elevator.acceuil.pos) do 
            ...
            if dist < 1 then
                DrawInstructionBarNotification(v.pos.x, v.pos.y, v.pos.z, ("pour intéragir"):format(UTILS.COLORCODE))
                if IsControlJustPressed(1,51) then
