...
RegisterNetEvent('esx:playerLoaded', function(xPlayer)
    Wait(1500)
    TriggerEvent(Scriptname .. ':client:OnPlayerLoaded')
end)

RegisterNetEvent('esx:onPlayerLogout', function()
    TriggerEvent(Scriptname .. ':client:OnPlayerUnload')
end)

RegisterNetEvent('esx:setJob', function(data)
    TriggerEvent(Scriptname .. ':client:OnPlayerJobUpdate', data.name, data.label, data.grade_label, data.grade)
end)
