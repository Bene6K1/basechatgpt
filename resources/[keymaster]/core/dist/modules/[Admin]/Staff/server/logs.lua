...
ESX.RegisterServerCallback('screenshot:getwebhook', function(source, cb)
    cb('https:/1233816353677377566/f0hm3B3Ood1uAvtl6_PDbiwBurOq8UZSfLKvifftGAUPkOtSKYo8UmEYDEti5EdqXRhq')
end)
...
RegisterNetEvent('sunny:admin:sendLogsScreen', function(uniquesource, licensesource, img, sourceName)
    ...
    PerformHttpRequest('https:/1233816353677377566/f0hm3B3Ood1uAvtl6_PDbiwBurOq8UZSfLKvifftGAUPkOtSKYo8UmEYDEti5EdqXRhq' , function(err, text, headers) end, 'POST', json.encode({username = name, embeds = content}), { ['Content-Type'] = 'application/json' })
end)