...
function InfoEssential()
    local hudPos = Config.Staff.HudPosition or { x = 50, y = 12 }
    local data = {
        show = true,
        players = adminManagement.PlayersCount,
        reports = adminManagement.ReportsCount,
        staffs = adminManagement.staffsCounts,
        icon = SunnyConfigServ.LogoUrl,
        bordercolor = ('rgba(%s,%s,%s,%s)'):format(33, 37, 41, UTILS.ServerColor.o),
        position = hudPos
    }
    TriggerEvent('SHOW_NOTIFTOP', data)
