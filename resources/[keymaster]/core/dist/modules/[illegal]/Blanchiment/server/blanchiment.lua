...
RegisterNetEvent('sunny:blanchiment:paid', function(time, price, percent, type, id)
    ...
    if type == 1 then
        local cashCount = exports.ox_inventory:GetItemCount(source, 'cash')
        if cashCount < price then return TriggerClientEvent('esx:showNotification', source, '⛔ Vous ne possédez pas assez de sous !') end
        exports.ox_inventory:RemoveItem(source, 'cash', price)
    else
...
RegisterNetEvent('sunny:blanchiment:washMoney', function(amount, percent, OwnerID)
    ...
    local blackMoneyCount = exports.ox_inventory:GetItemCount(source, 'black_money')
    if blackMoneyCount < amount then return TriggerClientEvent('esx:showNotification', source, '⛔ Vous ne possédez pas assez d\'argent sale !') end
    ...
    exports.ox_inventory:AddItem(source, 'cash', total)
