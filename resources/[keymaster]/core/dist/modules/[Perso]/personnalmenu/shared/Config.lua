...
Config.Personalmenu = {
    ...
    -- Liste des métiers qui ne peuvent pas vendre de drogue
    blackListedRole = {
        ['police'] = true,
        ['sheriff'] = true,
        ['bcso'] = true,
...
Config.Personalmenu.preferences = {
        ...
        ['clone_inventory'] = {
            ...
            active = true,
            action = function(bool)
                -- Fonction désactivée temporairement (migration ox_inventory)
                -- ox_inventory ne nécessite pas cette fonctionnalité
                print('[PersonalMenu] Clone inventaire : ' .. tostring(bool))
            end,
        },
    }
