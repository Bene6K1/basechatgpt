...
function SetVehicleProperties(vehicle, props)
    ...
    -- Vérifier que les propriétés actuelles ont été récupérées
    if currentProps and (currentProps.neonEnabled == nil or currentProps.neonEnabled == false) then
...
local LsCustoms = {
    Pos = {
        {pos = vector3(-208.511765, -1336.053467, 31.300480), job = "mecano", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Benny's~s~.", size = 20.0},
        {pos = vector3(-214.471405, -1335.609009, 31.301208), job = "mecano", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Benny's~s~.", size = 20.0},
        {pos = vector3(-222.184830, -1336.030151, 31.300486), job = "mecano", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Benny's~s~.", size = 20.0},
        {pos = vector3(-194.641388, -1326.973267, 31.300486), job = "mecano", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Benny's~s~.", size = 20.0},

        {pos = vec3(-325.27117919922, -158.01174926758, 39.01025390625), job = "garage_lscustom", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."LsCustoms's~s~.", size = 25.0},
        {pos = vec3(-322.30310058594, -150.49090576172, 39.010250091553), job = "garage_lscustom", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."LsCustoms's~s~.", size = 25.0},
        {pos = vec3(-319.68572998047, -143.00714111328, 39.01025390625), job = "garage_lscustom", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."LsCustoms's~s~.", size = 25.0},
        {pos = vec3(-317.02014160156, -134.93591308594, 39.010334014893), job = "garage_lscustom", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."LsCustoms's~s~.", size = 25.0},
        {pos = vec3(-314.15426635742, -127.28285217285, 39.010330200195), job = "garage_lscustom", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."LsCustoms's~s~.", size = 25.0},
        {pos = vec3(-345.2490234375, -158.56196594238, 39.01025390625), job = "garage_lscustom", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."LsCustoms's~s~.", size = 25.0},
        {pos = vec3(-338.80657958984, -161.39724731445, 39.01025390625), job = "garage_lscustom", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."LsCustoms's~s~.", size = 25.0},

        {pos = vec3(2695.0224609375, 3480.7543945312, 55.523509979248), job = "garage_speedhunters", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Speed Hunters's~s~.", size = 25.0},
        {pos = vec3(2698.2541503906, 3488.0305175781, 55.523567199707), job = "garage_speedhunters", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Speed Hunters's~s~.", size = 25.0},
        {pos = vec3(2700.6748046875, 3495.6921386719, 55.523551940918), job = "garage_speedhunters", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Speed Hunters's~s~.", size = 25.0},
        {pos = vec3(2704.0202636719, 3502.8371582031, 55.523555755615), job = "garage_speedhunters", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Speed Hunters's~s~.", size = 25.0},
        {pos = vec3(2729.0236816406, 3511.3781738281, 55.527484893799), job = "garage_speedhunters", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Speed Hunters's~s~.", size = 25.0},
        {pos = vec3(2722.4714355469, 3514.4411621094, 55.535961151123), job = "garage_speedhunters", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Speed Hunters's~s~.", size = 25.0},
        
        {pos = vec3(-213.84262084961, -1372.2950439453, 31.325481414795), job = "garage_octacyp", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Octa Cyp Garage~s~.", size = 25.0},
        {pos = vec3(-210.13037109375, -1378.5399169922, 31.325483322144), job = "garage_octacyp", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Octa Cyp Garage~s~.", size = 25.0},
        {pos = vec3(-259.5616, -1349.1478, 31.2958), job = "garage_octacyp", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Octa Cyp Garage~s~.", size = 25.0},
        
        {pos = vec3(-812.73895263672, -427.07696533203, 36.705165863037), job = "garage_driveline", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Driveline Garage~s~.", size = 25.0},
        {pos = vec3(-802.88037109375, -440.11996459961, 36.657379150391), job = "garage_driveline", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Driveline Garage~s~.", size = 25.0},
        {pos = vec3(-808.21008300781, -435.78225708008, 36.70516204834), job = "garage_driveline", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Driveline Garage~s~.", size = 25.0},
        
        {pos = vec3(941.6198, -2030.0651, 30.1176), job = "garage_eastcustoms", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."East Custom's~s~.", size = 25.0},
        {pos = vec3(933.1258, -2027.8925, 30.1816), job = "garage_eastcustoms", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."East Custom's~s~.", size = 25.0},
        {pos = vec3(903.25177001953, -2102.9934082031, 30.508003234863), job = "garage_eastcustoms", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."East Custom's~s~.", size = 25.0},
        {pos = vec3(913.61401367188, -2103.87890625, 30.459421157837), job = "garage_eastcustoms", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."East Custom's~s~.", size = 25.0},
        {pos = vec3(909.21337890625, -2128.1584472656, 30.558614730835), job = "garage_eastcustoms", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."East Custom's~s~.", size = 25.0},
        {pos = vec3(897.71832275391, -2127.1689453125, 30.55860710144), job = "garage_eastcustoms", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."East Custom's~s~.", size = 25.0},
        {pos = vec3(887.13055419922, -2126.2744140625, 30.558429718018), job = "garage_eastcustoms", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."East Custom's~s~.", size = 25.0},
        {pos = vec3(875.81268310547, -2125.1145019531, 30.55157661438), job = "garage_eastcustoms", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."East Custom's~s~.", size = 25.0},
        
        {pos = vec3(-254.11236572266, 6092.1591796875, 31.418849945068), job = "garage_paletocustoms", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Paleto Custom's~s~.", size = 25.0},
        {pos = vec3(-248.40444946289, 6097.5581054688, 31.41236114502), job = "garage_paletocustoms", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Paleto Custom's~s~.", size = 25.0},
        {pos = vec3(-236.7679901123, 6109.2348632812, 31.489398956299), job = "garage_paletocustoms", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Paleto Custom's~s~.", size = 25.0},
        {pos = vec3(-232.41329956055, 6104.1640625, 31.469728469849), job = "garage_paletocustoms", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Paleto Custom's~s~.", size = 25.0},
        {pos = vec3(-227.64511108398, 6099.3022460938, 31.482843399048), job = "garage_paletocustoms", notif = "pour accéder au "..SunnyConfigServ.GTACOLOR.."Paleto Custom's~s~.", size = 25.0},
    },
...
function MenuCustomization()
    ...
    LsCustoms.subMenuColourCategories = RageUI.CreateSubMenu(LsCustoms.subMenuColour, " ", "Catégories de couleurs")
    LsCustoms.subMenuColourShades = RageUI.CreateSubMenu(LsCustoms.subMenuColourCategories, " ", "Nuances")
    ...
    LsCustoms.subMenuColourCategories:DisplayGlare(false)
    LsCustoms.subMenuColourShades:DisplayGlare(false)
...
LsCustoms.mainMenu.Closable = false
    ...
    if LsCustoms.openedMenu then   
        ...
        if not LsCustoms.Vehicle or LsCustoms.Vehicle == 0 then
        ...
        if not LsCustoms.Prop then
            ESX.ShowNotification('~r~Erreur lors de la récupération des propriétés du véhicule')
            LsCustoms.openedMenu = false
            menucustomisopne = false
            return
        end
        ...
        -- Couleurs organisées par catégories
        LsCustoms.ColorCategories = {
            {name = "Rouge", type = "primary"},
            {name = "Bleu", type = "primary"},
            {name = "Vert", type = "primary"},
            {name = "Jaune", type = "primary"},
            {name = "Orange", type = "primary"},
            {name = "Violet", type = "primary"},
            {name = "Rose", type = "primary"},
            {name = "Blanc", type = "primary"},
            {name = "Noir", type = "primary"},
            {name = "Gris", type = "primary"},
            {name = "Marron", type = "primary"},
            {name = "Métal", type = "special"},
            {name = "Mat", type = "special"},
            {name = "Chrome", type = "special"}
        }
        
        LsCustoms.ColorShades = {
            ["Rouge"] = {
                {name = "Rouge Métal", id = 27, price = 250},
                {name = "Rouge Torino", id = 28, price = 250},
                {name = "Rouge Formula", id = 29, price = 250},
                {name = "Rouge Blaze", id = 30, price = 250},
                {name = "Rouge Grace", id = 31, price = 250},
                {name = "Rouge Garnet", id = 32, price = 250},
                {name = "Rouge Sunset", id = 33, price = 250},
                {name = "Rouge Cabernet", id = 34, price = 250},
                {name = "Rouge Candy", id = 35, price = 500},
                {name = "Rouge Mat", id = 39, price = 750},
                {name = "Rouge Foncé Mat", id = 40, price = 750},
                {name = "Rouge Wine", id = 143, price = 500},
                {name = "Rouge Lava", id = 150, price = 500}
            },
            ["Bleu"] = {
                {name = "Bleu Galaxy", id = 61, price = 250},
                {name = "Bleu Foncé", id = 62, price = 250},
                {name = "Bleu Saxon", id = 63, price = 250},
                {name = "Bleu Métal", id = 64, price = 250},
                {name = "Bleu Mariner", id = 65, price = 250},
                {name = "Bleu Harbor", id = 66, price = 250},
                {name = "Bleu Diamond", id = 67, price = 250},
                {name = "Bleu Surf", id = 68, price = 250},
                {name = "Bleu Nautical", id = 69, price = 250},
                {name = "Bleu Ultra", id = 70, price = 500},
                {name = "Bleu Racing", id = 73, price = 500},
                {name = "Bleu Clair", id = 74, price = 250},
                {name = "Bleu Foncé Mat", id = 82, price = 750},
                {name = "Bleu Mat", id = 83, price = 750},
                {name = "Bleu Midnight Mat", id = 84, price = 750},
                {name = "Bleu Midnight", id = 141, price = 500}
            },
            ["Vert"] = {
                {name = "Vert Foncé", id = 49, price = 250},
                {name = "Vert Racing", id = 50, price = 250},
                {name = "Vert Sea", id = 51, price = 250},
                {name = "Vert Olive", id = 52, price = 250},
                {name = "Vert Bright", id = 53, price = 250},
                {name = "Vert Gasoline", id = 54, price = 250},
                {name = "Vert Lime", id = 92, price = 500},
                {name = "Vert Lime Mat", id = 55, price = 750},
                {name = "Vert Mat", id = 128, price = 750},
                {name = "Vert Frost Mat", id = 151, price = 750},
                {name = "Vert Olive Mat", id = 152, price = 750}
            },
            ["Jaune"] = {
                {name = "Jaune Métal", id = 88, price = 250},
                {name = "Jaune Course", id = 89, price = 250},
                {name = "Jaune Dew", id = 91, price = 250},
                {name = "Jaune Mat", id = 42, price = 750}
            },
            ["Orange"] = {
                {name = "Orange Sunrise", id = 36, price = 250},
                {name = "Orange Métal", id = 38, price = 250},
                {name = "Orange Bright", id = 138, price = 500},
                {name = "Orange Mat", id = 41, price = 750}
            },
            ["Violet"] = {
                {name = "Violet Schafter", id = 71, price = 250},
                {name = "Violet Spinnaker", id = 72, price = 250},
                {name = "Violet Midnight", id = 142, price = 250},
                {name = "Violet Bright", id = 145, price = 500},
                {name = "Violet Schafter Mat", id = 148, price = 750},
                {name = "Violet Midnight Mat", id = 149, price = 750}
            },
            ["Rose"] = {
                {name = "Rose Hot", id = 135, price = 250},
                {name = "Rose Salmon", id = 136, price = 250},
                {name = "Rose Pfsiter", id = 137, price = 500}
            },
            ["Blanc"] = {
                {name = "Blanc Cream", id = 107, price = 250},
                {name = "Blanc Ice", id = 111, price = 250},
                {name = "Blanc Frost", id = 112, price = 250},
                {name = "Blanc Ice Mat", id = 131, price = 750}
            },
            ["Noir"] = {
                {name = "Noir Métal", id = 0, price = 250},
                {name = "Noir Graphite", id = 1, price = 250},
                {name = "Noir Steel", id = 2, price = 250},
                {name = "Noir Dark Steel", id = 3, price = 250},
                {name = "Noir Shadow Silver", id = 7, price = 250},
                {name = "Noir Midnight Silver", id = 9, price = 250},
                {name = "Noir Cast Iron", id = 10, price = 250},
                {name = "Noir Anthracite", id = 11, price = 250},
                {name = "Noir Mat", id = 12, price = 750},
                {name = "Noir Carbon", id = 147, price = 500}
            },
            ["Gris"] = {
                {name = "Gris Silver", id = 4, price = 250},
                {name = "Gris Bluish Silver", id = 5, price = 250},
                {name = "Gris Rolled Steel", id = 6, price = 250},
                {name = "Gris Stone Silver", id = 8, price = 250},
                {name = "Gris Mat", id = 13, price = 750},
                {name = "Gris Clair Mat", id = 14, price = 750}
            },
            ["Marron"] = {
                {name = "Marron Bronze", id = 90, price = 250},
                {name = "Marron Feltzer", id = 94, price = 250},
                {name = "Marron Creek", id = 95, price = 250},
                {name = "Marron Chocolat", id = 96, price = 250},
                {name = "Marron Maple", id = 97, price = 250},
                {name = "Marron Saddle", id = 98, price = 250},
                {name = "Marron Straw", id = 99, price = 250},
                {name = "Marron Moss", id = 100, price = 250},
                {name = "Marron Bison", id = 101, price = 250},
                {name = "Marron Woodbeech", id = 102, price = 250},
                {name = "Marron Beechwood", id = 103, price = 250},
                {name = "Marron Sienna", id = 104, price = 250},
                {name = "Marron Sandy", id = 105, price = 250},
                {name = "Marron Bleached", id = 106, price = 250},
                {name = "Marron Desert Mat", id = 154, price = 750},
                {name = "Marron Earth Mat", id = 155, price = 750}
            },
            ["Métal"] = {
                {name = "Acier Brossé", id = 117, price = 800},
                {name = "Acier Noir Brossé", id = 118, price = 800},
                {name = "Aluminium Brossé", id = 119, price = 800},
                {name = "Chrome", id = 120, price = 1000},
                {name = "Or Pur", id = 158, price = 1500},
                {name = "Or Brossé", id = 159, price = 1500}
            },
            ["Mat"] = {
                {name = "Noir Mat", id = 12, price = 750},
                {name = "Gris Mat", id = 13, price = 750},
            ...
            ["Chrome"] = {
                {name = "Chrome Argenté", id = 120, price = 1000},
                {name = "Or Pur", id = 158, price = 1500},
                {name = "Or Brossé", id = 159, price = 1500}
            }
        }
        
        LsCustoms.SelectedCategory = 1
        LsCustoms.SelectedShade = 1
        LsCustoms.ColorType = "primary"
            ...
            CreateThread(function()
                while LsCustoms.openedMenu do
                    ...
                    RageUI.IsVisible(LsCustoms.subMenuColour, function()
                        RageUI.Button("Couleur Primaire", nil, {RightLabel = "→"}, true, {
                            onSelected = function()
                                LsCustoms.ColorType = "primary"
                            end
                        }, LsCustoms.subMenuColourCategories)
                        
                        RageUI.Button("Couleur Secondaire", nil, {RightLabel = "→"}, true, {
                            onSelected = function()
                                LsCustoms.ColorType = "secondary"
                            end
                        }, LsCustoms.subMenuColourCategories)
                        ...
                        RageUI.List("Nacrage", LsCustoms.ColourIntDashNacrage, LsCustoms.DefaultNacrageColour, nil, {}, true, {
                            onListChange = function(Index)
                                ...
                                if LsCustoms.Prop.pearlescentColor == pearlescentColor then
                                    ...
                                    LsCustoms.PriceNacrage = 220
                                end
                            end,
                        })
                    end)
                    RageUI.IsVisible(LsCustoms.subMenuColourCategories, function()
                        local categoryNames = {}
                        for i, category in ipairs(LsCustoms.ColorCategories) do
                            table.insert(categoryNames, category.name)
                        end
                        
                        for i, category in ipairs(LsCustoms.ColorCategories) do
                            RageUI.Button(category.name, nil, {RightLabel = "→"}, true, {
                                onSelected = function()
                                    LsCustoms.SelectedCategory = i
                                end
                            }, LsCustoms.subMenuColourShades)
                        end
                    end)
                    RageUI.IsVisible(LsCustoms.subMenuColourShades, function()
                        local selectedCategoryName = LsCustoms.ColorCategories[LsCustoms.SelectedCategory].name
                        local shades = LsCustoms.ColorShades[selectedCategoryName]
                        
                        if shades then
                            for i, shade in ipairs(shades) do
                                local priceLabel = "~g~" .. shade.price .. "$"
                                RageUI.Button(shade.name, nil, {RightLabel = priceLabel}, true, {
                                    onSelected = function()
                                        local primaire, secondaire = GetVehicleColours(LsCustoms.Vehicle)
                                        
                                        if LsCustoms.ColorType == "primary" then
                                            ClearVehicleCustomPrimaryColour(LsCustoms.Vehicle)
                                            SetVehicleColours(LsCustoms.Vehicle, shade.id, secondaire)
                                            LsCustoms.DefaultPrimaireColour = shade.id
                                            
                                            if LsCustoms.Prop.color1 == shade.id then
                                                LsCustoms.PricePrimary = 0
                                            else
                                                LsCustoms.PricePrimary = shade.price
                                            end
                                        elseif LsCustoms.ColorType == "secondary" then
                                            ClearVehicleCustomSecondaryColour(LsCustoms.Vehicle)
                                            SetVehicleColours(LsCustoms.Vehicle, primaire, shade.id)
                                            LsCustoms.DefaultSecondaireColour = shade.id
                                            
                                            if LsCustoms.Prop.color2 == shade.id then
                                                LsCustoms.PriceSecondary = 0
                                            else
                                                LsCustoms.PriceSecondary = shade.price
                                            end
                                        end
                                    end
                                })
                        ...
                        RageUI.List("Jantes principales", LsCustoms.JantesPrincipales, LsCustoms.DefaultJantesPrincipales, nil, {}, true, {
                            onListChange = function(Index)
                                ...
                                if LsCustoms.Prop.modFrontWheels == GetVehicleMod(LsCustoms.Vehicle, 23) then
                                    ...
                                    LsCustoms.PriceJantesPrincipales = 1200
                                end
                            end,
                        })
                    ...
                    RageUI.IsVisible(LsCustoms.subMenuClassiques, function()
                        ...
                        RageUI.Checkbox("Phares xenons", false, LsCustoms.DefaultPharesXenons, {}, {
                            onChecked = function()
                                ...
                                LsCustoms.PricePharesXenons = 850
                            end,
                            ...
                            RageUI.List("Couleur des phares", LsCustoms.CoulorPhares, LsCustoms.DefaultColourPhares, nil, {}, true, {
                                onListChange = function(Index)
                                    ...
                                    if LsCustoms.DefaultColourPhares - 1 == 0 then
                                        ...
                                        LsCustoms.PriceColorPhares = 280
                                    end
                                end,
                            })
                        else
                                ...
                                RageUI.List("Pare-choc avant", GetModObjects(LsCustoms.Vehicle, 1), LsCustoms.DefaultParechocAvant, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modFrontBumper == GetVehicleMod(LsCustoms.Vehicle, 1) then
                                            ...
                                            LsCustoms.PriceParechocAvant = 850
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Pare-choc arrière", GetModObjects(LsCustoms.Vehicle, 2), LsCustoms.DefaultParechocArriere, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modRearBumper == GetVehicleMod(LsCustoms.Vehicle, 2) then
                                            ...
                                            LsCustoms.PriceParechocArriere = 850
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Carrosserie", GetModObjects(LsCustoms.Vehicle, 3), LsCustoms.DefaultCarrosserie, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modSideSkirt == GetVehicleMod(LsCustoms.Vehicle, 3) then
                                            ...
                                            LsCustoms.PriceCarrosserie = 680
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Echappement", GetModObjects(LsCustoms.Vehicle, 4), LsCustoms.DefaultEchappement, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modExhaust == GetVehicleMod(LsCustoms.Vehicle, 4) then
                                            ...
                                            LsCustoms.PriceEchappement = 420
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Autocollant gauche", GetModObjects(LsCustoms.Vehicle, 8), LsCustoms.DefaultAutocollantGauche, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modFender == GetVehicleMod(LsCustoms.Vehicle, 8) then
                                            ...
                                            LsCustoms.PriceAutocollantGauche = 80
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Autocollant droit", GetModObjects(LsCustoms.Vehicle, 9), LsCustoms.DefaultAutocollantDroit, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modRightFender == GetVehicleMod(LsCustoms.Vehicle, 9) then
                                            ...
                                            LsCustoms.PriceAutocollantDroit = 80
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Support de plaque", GetModObjects(LsCustoms.Vehicle, 25), LsCustoms.DefaultSupportPlaque, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modPlateHolder == GetVehicleMod(LsCustoms.Vehicle, 25) then
                                            ...
                                            LsCustoms.PriceSupportPlaque = 180
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Plaque avant", GetModObjects(LsCustoms.Vehicle, 26), LsCustoms.DefaultPlaqueAvant, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modVanityPlate == GetVehicleMod(LsCustoms.Vehicle, 26) then
                                            ...
                                            LsCustoms.PriceSupportPlaque = 120
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Tableau de bord motif", GetModObjects(LsCustoms.Vehicle, 29), LsCustoms.DefaultDashboardMotif, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modDashboard == GetVehicleMod(LsCustoms.Vehicle, 29) then
                                            ...
                                            LsCustoms.PriceDashboardMotif = 280
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Haut parleur portes", GetModObjects(LsCustoms.Vehicle, 31), LsCustoms.DefaultHautParleurPortes, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modDoorSpeaker == GetVehicleMod(LsCustoms.Vehicle, 31) then
                                            ...
                                            LsCustoms.PriceHautParleurPortes = 120
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Motif sieges", GetModObjects(LsCustoms.Vehicle, 32), LsCustoms.DefaultMotifSieges, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modSeats == GetVehicleMod(LsCustoms.Vehicle, 32) then
                                            ...
                                            LsCustoms.PriceMotifSieges = 420
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Haut parleur vitre", GetModObjects(LsCustoms.Vehicle, 36), LsCustoms.DefaultHautParleurVitre, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modSpeakers == GetVehicleMod(LsCustoms.Vehicle, 36) then
                                            ...
                                            LsCustoms.PriceHautParleurVitre = 180
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Haut parleur coffre", GetModObjects(LsCustoms.Vehicle, 37), LsCustoms.DefaultHautParleurCoffre, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modTrunk == GetVehicleMod(LsCustoms.Vehicle, 37) then
                                            ...
                                            LsCustoms.PriceHautParleurCoffre = 380
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Hydrolique", GetModObjects(LsCustoms.Vehicle, 38), LsCustoms.DefaultHydrolique, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modHydrolic == GetVehicleMod(LsCustoms.Vehicle, 38) then
                                            ...
                                            LsCustoms.PriceHydrolique = 2200
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Moteur", GetModObjects(LsCustoms.Vehicle, 39), LsCustoms.DefaultVisualMoteur, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modEngineBlock == GetVehicleMod(LsCustoms.Vehicle, 39) then
                                            ...
                                            LsCustoms.PriceVisualMoteur = 1800
                                        end
                                    end,
                                })
                            end
                                ...
                                RageUI.List("Entretoises", GetModObjects(LsCustoms.Vehicle, 41), LsCustoms.DefaultEntretoises, nil, {}, true, {
                                    onListChange = function(Index)
                                        ...
                                        if LsCustoms.Prop.modStruts == GetVehicleMod(LsCustoms.Vehicle, 41) then
                                            ...
                                            LsCustoms.PriceEntretoises = 180
                                        end
                                    end,
                                })
                            end
                            ...
                            RageUI.List("Suspension", {"Stock", "Discount", "Street", "Sport", "Race"}, LsCustoms.DefaultSuspension, nil, {}, true, {
                                onListChange = function(Index)
                                    ...
                                    if LsCustoms.Prop.modSuspension == GetVehicleMod(LsCustoms.Vehicle, 15) then
                                        ...
                                        LsCustoms.PriceSuspension = 3500
                                    end
                                end,
                            })
                        end
                            ...
                            RageUI.List("Transmission", {"Stock","Street", "Sport", "Race"}, LsCustoms.DefaultTransmission, nil, {}, true, {
                                onListChange = function(Index)
                                    ...
                                    if LsCustoms.Prop.modTransmission == GetVehicleMod(LsCustoms.Vehicle, 13) then
                                        ...
                                        LsCustoms.PriceTransmission = 4800
                                    end
                                end,
                            })
                        end
                        ...
                        for _, neon in pairs(neonPositions) do
                            ...
                            RageUI.Checkbox("Néon " .. neon.name, nil, isActive, {}, {
                                onChecked = function()
                                    ...
                                    LsCustoms.PriceNeon = (LsCustoms.PriceNeon or 0) + 180
                                end,
                                onUnChecked = function()
                    ...
                    if not RageUI.Visible(LsCustoms.mainMenu) and not RageUI.Visible(LsCustoms.subMenuColour) and not RageUI.Visible(LsCustoms.subMenuColourCategories) and not RageUI.Visible(LsCustoms.subMenuColourShades) and not RageUI.Visible(LsCustoms.subMenuRoues) and not RageUI.Visible(LsCustoms.subMenuClassiques) and not RageUI.Visible(LsCustoms.subMenuCustoms) and not RageUI.Visible(LsCustoms.subMenuPerf) and not RageUI.Visible(LsCustoms.subMenuExtra) and not RageUI.Visible(LsCustoms.subMenuModification) then
                        LsCustoms.mainMenu = RMenu:DeleteType('mainMenu')
                        menucustomisopne = false
                        LsCustoms.openedMenu = false
                        if LsCustoms.Vehicle then
...
AddEventHandler('Mecano:installMod', function()
	myCar = lib.getVehicleProperties(GetVehiclePedIsIn(PlayerPedId(), false))
...
Citizen.CreateThread(function()
    for k,v in pairs(LsCustoms.Pos) do
        AddZones(k, {
            ...
            Blip = {},
            ActionText = 'Atelier de customisation',
            Action = function()
    ...
    AddZones('neons_bennys', {
        ...
        InVehicleDisable = false,
        Blip = {},
        ActionText = 'Configurer les néons (Bennys)',
        Action = function()
            openZMAIBNMENU()
        end
    })
    ...
    AddZones('neons_lscustom', {
        ...
        InVehicleDisable = false,
        Blip = {},
        ActionText = 'Configurer les néons (LSCustom)',
        Action = function()
            openZMAIBNMENU()
        end
    })
    ...
    --                 if dist <= v.size then 
    --                     wait = 5
    --                     ESX.ShowHelpNotification("pour ouvrir le menu.")
