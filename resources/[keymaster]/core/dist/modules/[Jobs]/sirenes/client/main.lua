...
Citizen.CreateThread(function()
	...
	while true do
		...
		if ESX.PlayerData ~= nil and ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name ~= nil and ESX.PlayerData.job.name == 'police' or ESX.PlayerData.job.name == 'ambulance' or ESX.PlayerData.job.name == 'ambulancecayo' or ESX.PlayerData.job.name == 'ambulancenord' or ESX.PlayerData.job.name == 'ambulancepillbox' then
			Citizen.Wait(0)
		else
			Citizen.Wait(2500)
		end
