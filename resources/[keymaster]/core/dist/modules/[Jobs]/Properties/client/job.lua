...
AddEventHandler('sunny:properties:job:service', function()
    ...
    while Properties.job.Service do 
        ...
        if dist <= 1 then
            DrawInstructionBarNotification(coords.x, coords.y, coords.z, ("pour intéragir"):format(UTILS.COLORCODE))
        ...
        -- if dist2 <= 1 then
        --     DrawInstructionBarNotification(coords2.x, coords2.y, coords2.z, ("pour intéragir"):format(UTILS.COLORCODE))
        --     if IsControlJustPressed(0, 54) then
