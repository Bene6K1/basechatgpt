...
function inCane()
    if ataTime ~= nil and ataTime > 0 and ataType == 1 then
        return true
    end
    return false
end
...
function ataThread(time, type) 
    ...
    if ataTime ~= nil and ataTime <= 10 then 
        return 
    end
...
Citizen.CreateThread(function()
    ...
    AddZones('pharmacie_emssandy', {
        ...
        ActionText = 'Accéder à la pharmacie',
        Action = function()
    ...
    AddZones('defibrilateur_emssandy', {
        ...
        ActionText = 'Prendre un défibrillateur',
        Action = function()
