    ...
    while true do
        ...
        -- for k,v in pairs(Activity.Acier) do
            ...
            if distAcier < 1.5 then
                DrawInstructionBarNotification(AcierX,AcierY,AcierZ, "Appuyez sur [E] pour récupérer la féraille")
            ...
            if distTAcier < 1.5 then
                DrawInstructionBarNotification(TAcierX,TAcierY,TAcierZ, "Appuyez sur [E] pour traiter")
                if IsControlJustPressed(1,51) then
            ...
            if distVacier < 1.5 then
                DrawInstructionBarNotification(VAcierX,VAcierY,VAcierZ, "Appuyez sur [E] pour vendre")
                if IsControlJustPressed(1,51) then
