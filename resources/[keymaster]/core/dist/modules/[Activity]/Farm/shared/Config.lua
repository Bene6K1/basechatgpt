Config_Farm = {
    ...
    Farm = {
       ...
       -- ["starpizza"] = {
        --    ["recolte"] = {
        --        vector3(968.895630, -2233.172852, 30.596891),
        --        vector3(971.269104, -2230.687744, 30.553455),
       --         vector3(967.949585, -2227.589355, 30.553482),
       --     },
      --      ["traitement"] = {
      --          vector3(132.162033, -3106.609375, 5.896310),
      --          vector3(125.451996, -3103.432129, 5.940472),
      --          vector3(124.482735, -3107.149658, 5.966130),
    --        },
    --    },
    },
    Items = {
    ...
    Sell = {
      ...
      --  ['starpizza'] = {
      --      Position = vector3(-1345.369385, -1064.695801, 7.390720),
      --      job = "starpizza",
   --     }
    },
    ...
    Blips = {
      ...
      --  ['starpizza'] = {
      --      ['recolte'] = {
      --          position = vector3(969.690735, -2222.998779, 30.553982),
       --         text = '[STARPIZZA] Récolte',
       --         blipId = 502,
       --         color = 8
       --     },
       --     ['traitement'] = {
       --         position = vector3(129.811768, -3106.125244, 5.899436),
       --         text = '[STARPIZZA] Traitement',
        --        blipId = 503,
        --        color = 8
       --    },
        --    ['vente'] = {
        --        position = vector3(-1345.567383, -1063.628296, 7.390726),
        --        text = '[STARPIZZA] Vente',
         --       blipId = 504,
         --       color = 8
       --     }
    --    },
