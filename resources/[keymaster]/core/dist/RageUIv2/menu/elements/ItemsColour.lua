RageUI.ItemsColour = {
  -- Tactical Dark Theme Colors (Monochrome)
  TacticalAccent = { 200, 200, 200, 255 },      -- Accent gris clair (#C8C8C8)
  TacticalAccentHover = { 80, 80, 80, 40 },     -- Hover gris subtil
  TacticalBackground = { 0, 0, 0, 220 },        -- Fond noir profond avec transparence
  TacticalBackgroundSolid = { 8, 8, 8, 255 },   -- Fond noir solide
  TacticalItemBg = { 13, 13, 13, 255 },         -- Fond des items
  TacticalBorder = { 42, 42, 42, 255 },         -- Bordure gris anthracite (#2a2a2a)
  TacticalBorderLight = { 51, 51, 51, 255 },    -- Bordure gris (#333333)
  TacticalTextPrimary = { 255, 255, 255, 255 }, -- Texte principal blanc pur
  TacticalTextSecondary = { 136, 136, 136, 255 }, -- Texte secondaire gris moyen (#888888)
  TacticalTextDimmed = { 170, 170, 170, 255 },  -- Texte atténué (#AAAAAA)
  ...
  DegenGreen = { 255, 0, 0, 255 },
  DegenCyan = { 0, 255, 255, 255 },
  DegenBlue = { 255, 0, 0, 255 },
