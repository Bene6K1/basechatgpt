  ...
  if CurrentMenu ~= nil and CurrentMenu then
    ...
    if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
      ...
      if Enabled then
        ...
        elseif Submenu and not Style.RightLabel and not Style.RightBadge then
        ...
        elseif not Submenu and not Style.RightLabel and not Style.RightBadge then
          if Active then
            RenderText(
              "→",
              CurrentMenu.X
...
function RageUI.Button(Label, Description, Style, Enabled, Action, Submenu)
  return Items:Button(Label, Description, Style, Enabled, Action, Submenu)
end
