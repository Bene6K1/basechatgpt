  ...
  if CurrentMenu ~= nil then
    if CurrentMenu then
      ...
      if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
        ...
        local ListText = (type(Items[Index]) == "table")
            and string.format("← %s →", Items[Index].value)
          or string.format("← %s →", Items[Index])
          or "undefined"
        ...
        if Enabled == true or Enabled == nil then
          if Selected then
            ListText = (type(Items[Index]) == "table")
                and string.format("← %s →", Items[Index].value)
              or string.format("← %s →", Items[Index])
              or "undefined"
            RenderText(
              Label,
              CurrentMenu.X - 3 + LeftBadgeOffset,
            ...
            RenderText(
              ListText,
              CurrentMenu.X - 10 + SettingsList.Text.X + 20 + CurrentMenu.WidthOffset - RightOffset,
              CurrentMenu.Y + SettingsList.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset,
              0,
            ...
            -- Liste inactif gris clair (Tactical Dark theme)
            RenderText(
              ListText,
              CurrentMenu.X - 10 + SettingsList.Text.X + 20 + CurrentMenu.WidthOffset - RightOffset,
              CurrentMenu.Y + SettingsList.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset,
          ...
          if haveRightBadge then
            ...
            RenderSprite(
              ...
              CurrentMenu.X + SettingsButton.RightBadge.X + 55 + CurrentMenu.WidthOffset,
              CurrentMenu.Y
          ...
          RenderText(
            Label,
            CurrentMenu.X + SettingsButton.Text.X - 6 + LeftBadgeOffset,
            CurrentMenu.Y + SettingsButton.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset,
            0,
            SettingsButton.Text.Scale,
            163,
