...
Config_Fournisseur.Jobs = {
    ['restau_burgershot'] = {
        ...
        { item = 'burgershot_sauce', label = 'Sauce BurgerShot', price = 5 },
    ...
    ['restau_catcafe'] = {
        { item = 'uwu_bubbletea', label = 'Bubble Tea', price = 5 },
        { item = 'uwu_pancake', label = 'Pancake', price = 5 },
        { item = 'uwu_cupcake', label = 'Cupcake', price = 5 },
        { item = 'uwu_burger', label = 'Burger Uwu', price = 5 },
        { item = 'burgershot_frite', label = 'Frite', price = 5 },
        { item = 'coca', label = 'Cola', price = 5 },
    },
}
...
Config_craftjob.CraftPoints = {
    ...
    ['restau_pearls'] = {x = -1842.0, y = -1198.0, z = 14.3},
    ['restau_catcafe'] = {x = -591.0, y = -1056.0, z = 22.3},
}
...
Config_craftjob.Recipes = {
    ...
    ['restau_catcafe'] = {
        ['uwu_menu_burger'] = {
            label = 'Menu Burger Uwu',
            ingredients = {
                { item = 'uwu_burger', label = 'Burger Uwu', count = 1 },
                { item = 'burgershot_frite', label = 'Frite', count = 1 },
                { item = 'coca', label = 'Cola', count = 1 },
            }
        },
        ['uwu_menu_pancake'] = {
            label = 'Menu Pancake',
            ingredients = {
                { item = 'uwu_pancake', label = 'Pancake', count = 1 },
                { item = 'uwu_bubbletea', label = 'Bubble Tea', count = 1 },
            }
        },
    },
}
