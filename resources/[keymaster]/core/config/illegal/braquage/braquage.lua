...
CONFIG_SHOP_ROBBERY.Shops = {
    ...
    { name = 'sup11', pos = vector3(-620.21472167969, -228.04461669922, 38.057006835938),  pedPos = vector3(-622.28088378906, -229.93978881836, 38.057056427002), heading = 305.87118530273, model = "a_m_y_hasjew_01" },
}
...
Banks = {
	...
	-- ["lasventurasfleeca"] = {
	-- 	position = vector3(7168.9653320312, 369.44543457031, 58.041973114014), -- Las Venturas
	-- 	reward = math.random(100000,150000),
	-- 	nameofbank = "Fleeca Bank",
	-- 	lastrobbed = 15200
	-- },
