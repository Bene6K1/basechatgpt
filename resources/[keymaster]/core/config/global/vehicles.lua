...
Config.AllowedJobsForEmergencyVehicles = {
    ['police'] = true,
    ['bcso'] = true,
    ['ambulance'] = true,
    ['saspn'] = true,
...
function Config.IsJobAllowedForEmergencyVehicles(jobName)
    return Config.AllowedJobsForEmergencyVehicles[jobName] == true
end
