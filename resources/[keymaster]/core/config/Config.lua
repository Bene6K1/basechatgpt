...
SunnyConfigServ = {
    ...
    ------ RAGEUI CONFIG ------
    BannerMenu = "https://r2.fivemanage.com/Xn3liC3UXPMlRlgbzX17D/bannerneva.png",
    BannerButton = "https://r2.fivemanage.com/Xn3liC3UXPMlRlgbzX17D/bannerneva.png",
    RageUI = {
        IgEdit = false, ----- MODIF DU MENU IG
        menuBackgroundAlpha = 180, ----- OPACITÉ DU FOND DU MENU (0-255, plus élevé = plus foncé)
        gradientAlpha = 150, ----- OPACITÉ DU GRADIENT DES ÉLÉMENTS SÉLECTIONNÉS (0-255, plus élevé = plus rouge au début)
        gradientColor = { R = 130, G = 127, B = 127 }, ----- COULEUR DU GRADIENT DE SÉLECTION
    },

    ------- RICH PRESENCE ------
    -- https://discord.com/developers/applications
    AppId = 1420506476853723317,
    Asset1 = "512",
    Asset2 = "512-2",
    Text = "N E V A ULTIMATE V1",
    ...
    ------ LEBONCOIN -------
    PosLeboncoin = vector3(68.997161865234, -1570.0560302734, 29.597759246826),
    ...
    Elevator = {
        ...
        {label = 'Accueil', position = vector3(-269.43521118164, -918.23693847656, 32.320922851562), t = 'casino'},
        {label = 'Bureau', position = vector3(-269.7326965332, -918.85321044922, 46.29825592041), t = 'casino'},
        {label = 'Héliport', position = vector3(-271.83212280273, -918.54766845703, 52.735095977783), t = 'casino'},
    ...
    ------ OX_TARGET PLAYER OPTIONS ------
    PlayerTargetOptions = {
        -- Option pour copier l'animation d'un joueur
        CopyAnimation = {
            Enabled = true,                         -- Activer/Désactiver l'option
            Label = "Copier l'animation",           -- Texte affiché
            Icon = "fa-solid fa-clone",             -- Icône FontAwesome
            Distance = 3.0,                         -- Distance max pour interagir
            NotificationSuccess = "Animation copiée : ~b~%s~s~",  -- %s = nom de l'animation
            NotificationNoAnim = "Aucune animation détectée sur le joueur cible.",
        },
        -- Option pour afficher l'ID du joueur
        ShowPlayerId = {
            Enabled = true,
            Label = "ID du joueur",
    ...
    Fishing = {
        ...
        fishList = {
            ...
            Zones = {
                ...
                ['ocean'] = {
                    {zone = 'Zone de Pêche (Eau Profonde)', position = vector3(-3792.1853027344, 4832.4658203125, 0.55358499288559), radius = 1000.0, color = 76},
    ...
    Activity = {
        Peds = {
            ["SELL_CHASSE"] = {
                ...
                tag = "Libba",
                text = "Appuyez sur [E] pour parler à Libba",
            ...
            ["START_LIVRAISONS"] = {
                model = "cs_joeminuteman",
                tag = "Leo",
                text = "Appuyez sur [E] pour parler à Leo",
        ...
        Blips = {
            ...
            -- CASINO & Las Venturas =  -- Blips

            -- {
            --     pos = vector3(-263.89981079102, -900.97296142578, 32.313831329346),
            --     blipid = 680,
            --     blipcolor = 1,
            --     text = "Casino"
            -- },
            -- {
            --     pos = vector3(1275.9107666016, -1428.3511962891, 34.85669708252),
            --     blipid = 679,
            --     blipcolor = 36,
            --     text = "Tunel de Las Venturas"
            -- },
            -- {
            --     pos = vector3(1567.9385986328, 3579.8400878906, 37.52131652832),
            --     blipid = 475,
            --     blipcolor = 34,
            --     text = "Motel"
            -- },
