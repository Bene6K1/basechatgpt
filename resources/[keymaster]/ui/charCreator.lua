...
creatorCoords = vec3(-600.78918457031, -708.55059814453, 120.6050567627)
creatorHeading = 355.77603149414
...
AddEventHandler("ui:charCreator:open", function()
    ...
    while not DoesEntityExist(playerPed) or not IsPedAPlayer(playerPed) do
        Citizen.Wait(500)
        playerPed = PlayerPedId()
    end

    if isInCreator then return end
    ...
    DisplayHud(false)
    if exports and exports['nv_hud'] and exports['nv_hud'].ToggleVisible then
    ...
    Citizen.SetTimeout(2000, function()
        if not isInCreator or not IsNuiFocused() then
            print("[CharCreator] UI non ouverte, tentative de réouverture...")
    ...
    SendNUIMessage({
        type = "creator:Open",
        server_logo = "https://r2.fivemanage.com/Xn3liC3UXPMlRlgbzX17D/image.png",
        server_color = "#74c0fc",
        data = {
            variations = {
                sex				= 1,
