...
Config.Locale = 'en'
 ...
 Config.Prices = {
  Nothing = {
    chance = 50,
    message = '~c~Malheureusement, vous n\'avez rien gagné, parfois on gagne, parfois on perd.~s~',
    price = {
      price_money = 0,
      item = {
        price_is_item = false,
  ...
  Common = {
    chance = 20,
    message = '~g~Vous avez gagné un nouveau ticket à gratter !~s~ Peut-être que cette fois vous gagnerez gros ?',
    price = {
      price_money = 0,
      item = {
        price_is_item = true,
  ...
  Rare = {
    chance = 15,
    message = '~g~Vous avez gagné !~s~ Achetez-vous quelque chose de sympa pour ~g~$250~s~ !',
    price = {
      price_money = 250,
      item = {
        price_is_item = false,
  ...
  Epic = {
    chance = 9,
    message = '~g~Vous avez gagné gros ! ~g~+ $750~s~!',
    price = {
      price_money = 750,
      item = {
        price_is_item = false,
  ...
  Legendary = {
    chance = 1,
    message = '~r~L~b~E~g~G~y~E~p~N~q~D~o~A~r~R~b~Y~s~! Vous avez gagné ~g~$1000~s~ !',
    price = {
      price_money = 1000,
      item = {
        price_is_item = false,
