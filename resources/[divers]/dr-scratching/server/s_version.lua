CreateThread(function(resourceName)
  ...
  PerformHttpRequest('https://raw.githubusercontent.com/xDreamLand/dream-versions/main/dr-scratching.json', function (errorCode, resultData, resultHeaders)
    ...
    local version <const> = retData.version or retData["latest-version"] or "unknown"
    if version ~= currentVersion then
      ...
      local updateMsg <const> = retData["update-message"] or nil
      if retData["requires-update"] and retData["requires-update"]["important"] and updateMsg ~= nil then
        print("")
