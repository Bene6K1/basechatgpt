--[[
    ...
    Copyright © 2025 Linden <github.com/thelindat>
]]

---Triggers an event for the given playerIds, sending additional parameters as arguments.\
---Implements functionality from [this pending pull request](github.com/citizenfx/fivem/pull/1210) and may be deprecated.
---
